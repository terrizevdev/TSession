...
import { 
    ...
    fetchLatestWaWebVersion,  // Using fetchLatestWaWebVersion
...
async function getPairingCode(phone) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            // USING fetchLatestWaWebVersion (same as main.js)
            ...
            const conn = makeWASocket({
                version: version, // Using version from fetchLatestWaWebVersion
